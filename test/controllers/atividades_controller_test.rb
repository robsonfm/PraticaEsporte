...
class AtividadesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create atividade" do
    assert_difference('Atividade.count') do
      post atividades_url, params: { atividade: { data: @atividade.data, duracao: @atividade.duracao, tipoatividade: @atividade.tipoatividade, titulo: @atividade.titulo, usuario: @atividade.usuario } }
    end
  ...
  test "should update atividade" do
    patch atividade_url(@atividade), params: { atividade: { data: @atividade.data, duracao: @atividade.duracao, tipoatividade: @atividade.tipoatividade, titulo: @atividade.titulo, usuario: @atividade.usuario } }
